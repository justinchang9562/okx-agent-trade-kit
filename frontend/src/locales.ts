...
const codeZh: Record<string, string> = {
  ...
  SUBMISSION_UNKNOWN: '提交状态未知', POSITION_UNPROTECTED: '仓位未受保护', EXPIRED: '已过期', PROTECTED: '已保护',
  ...
  SUBMISSION_UNKNOWN_REQUIRES_RECONCILIATION: '订单提交状态未知，需要与交易所核对', SUBMISSION_UNKNOWN_RECONCILIATION_REQUIRED: '订单提交状态未知，需要与交易所核对',
